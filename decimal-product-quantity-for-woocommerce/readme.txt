...
= 20.65 =
	2026.03.17
	* (Thanks to PR24)
	* Fix "Get_WDPQ_CartItem_by_ProductID".
	* Add Link to Setup Options Page.
...
= 20.63 =
	2026.02.13
	* (Thanks to PR24)
	* Fix Column "Quantity" for Product Category List.
	* Fix Call Debuger. (Product Setup).
	* Fix Check_Input_Parameters.
	* Fix Normalize_Number.
	* Fix DecimalValueFormatting.
	* Fix Remove Cart Item.
	* Ready for MiniCarts (experience).
...
= 18.57 =
	2025.06.16
	* Fix Cart Processing after remove Variation Item. (Thanks to Alanstones)
	
= 18.56.2 =
	2025.05.30
	* Fix Non fatal error. Thanks to shawfactor.
...
= 10.32 =
	2024.01.31
	* Fix red-view "Price Unit-Label" about in Product Setup page.
	* Tested to WP: 6.4.3
